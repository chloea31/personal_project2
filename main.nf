...
process MultiQC {
    ...
    input:
        // path path2html
        // path path2zip 
        // list of HTMLs and zip files, and the command echo displays the elements of the list with a space
        path multiqc_channel
...
workflow {
    ...
    (qc_reports_html, qc_reports_zip) = QC(fastq_files_1.mix(fastq_files_2)) 
